...
Examples =
{
    ...
    candle :
	{
		...
		velocityStyle  : Type.CUBE,
		velocityBase   : new THREE.Vector3(-300,0,0),
		velocitySpread : new THREE.Vector3(0,20,20),
		
		particleTexture : THREE.ImageUtils.loadTexture( 'images/smokeparticle.png' ),
		
		sizeTween    : new Tween( [0, 0.0, 0.4], [40, 150, 1] ),
		opacityTween : new Tween( [0.9, 1.5], [1, 0] ),
		colorTween   : new Tween( [0.9, 1.0], [ new THREE.Vector3(0.01, 1, 0.3), new THREE.Vector3(0.05, 1, 0) ] ),
		blendStyle : THREE.AdditiveBlending,  
		
		particlesPerSecond : 250,
		particleDeathAge   : 0.80,		
		emitterDeathAge    : 60
	},
	...
	{
		positionStyle  : Type.CUBE,
		positionBase   : new THREE.Vector3( 0, 0, 110 ),
		positionRadius : 20,
		
		velocityStyle  : Type.CUBE,
		velocityBase   : new THREE.Vector3(0,0,300),
		velocitySpread : new THREE.Vector3(30,20,0),
